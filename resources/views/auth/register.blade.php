<x-layouts.app title="Register" meta-description="Contact meta description">
    <h1 class="my-4 text-3xl text-center text-sky-500 dark:text-sky-500 font-bold">Register</h1>
