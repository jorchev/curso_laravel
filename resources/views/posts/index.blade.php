<x-layouts.app title='Blog' meta-description="Blog meta description">
    <header class="px-6 py-4 space-y-2 text-center">
        <h1 class="text-3xl text-center text-sky-500 dark:text-sky-500 font-bold">Blog</h1>
            ...
            <div class="max-w-3xl px-4 py-2 space-y-4 bg-white rounded shadow dark:bg-slate-800">
                ...
                @auth
                    <div class="flex justify-between">
                        <a class="inline-flex items-center text-xs font-semibold tracking-widest text-center uppercase transition duration-150 ease-in-out dark:text-slate-400 text-slate-500 hover:text-slate-600 dark:hover:text-slate-500 focus:outline-none focus:border-slate-200" href="{{ route('posts.edit', $post->id) }}">Edit</a>
