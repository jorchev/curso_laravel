                    ...
                    <div class="flex space-x-4">
                        ...
                        @auth
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <a href="#" class="lg:px-3 py-2 text-sm font-medium rounded-md hover:text-sky-600 dark:hover:text-white dark:text-slate-400" onclick="this.closest('form').submit()">Logout</a>
                            </form>
                        @endauth
                    </div>
                </div>
